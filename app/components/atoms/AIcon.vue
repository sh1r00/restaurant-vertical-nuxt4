...
const colorClass = computed(() => 'text-current')
...
const icons: IconSet = {
  ...
  'leaf': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.9C15.5 4.9 17 3.8 19 2c1 3-2 7.5-4 11"/><path d="M2 21c.5-3.5 1.5-6 4-8"/></svg>',
  'wine': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 22h8"/><path d="M12 11v11"/><path d="M12 11a4 4 0 0 0 4-4V3H8v4a4 4 0 0 0 4 4z"/></svg>',
}
